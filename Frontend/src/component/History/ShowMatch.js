  ...
  return (
    <div>
      <div className="content-showmatch">
        <button type="button" class="btn-close BTN-Close" aria-label="Close" onClick={onClickClose}/>
         <div className="content-showmatch-popup-bg" >
          <div className="content-showmatch-popup-use" >
            
            <SelectRound onChangeRound={onChangeRound} statusRound={status.game_round}  round={cardsData.record_card}/>
